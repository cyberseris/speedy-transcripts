...
--
-- Deliberately minimal. SRT/VTT output, LLM cleanup columns, human-review
-- (*_reviewed) columns and error_message are all deferred to later milestones --
-- the M1 checklist actively fails if any of them show up here.
